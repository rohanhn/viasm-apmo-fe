...
// Fetch country rankings data from API
async function fetchCountryRankings(year: string): Promise<CountryRanking[]> {
  try {
    ...
    const url = `https://viasm-dev.trangnguyen.edu.vn/api/country-rankings?populate=*&${filters.join(
      '&'
    )}`;
...
export async function generateMetadata({
  ...
  return {
    ...
    keywords: `APMO, ${year}, country rankings, mathematics olympiad, results`,
  };
}
